...
function Config(conf, data) {
	...
	if (this.template == undefined || this.template == '') {
	    this.template = '';
	    this.template += '<img src="http://www.yunai.me/images/common/wechat_mp.jpeg" /><br />';
	    // console.log(data);
	    // console.log(data.date);
	    // var kouling = data.date.replace('-', '').replace('-', '');
	    // this.template += '↑↑↑ ' + '关注微信号' + '' + ' ↑↑↑';
	    this.template += '<font size="2" color="red">↑↑↑ 关注微信公众号，发送【beta】提前查看文章</font>';
